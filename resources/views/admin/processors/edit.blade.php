        ...
        <main class="max-w-7xl p-12 mx-auto">
            <form action="{{ route('admin.processors.update', $processor) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mt-1">
                    ...
                    <x-input type="number"  name="name" class="w-full block text-black"></x-input>
                </div>
                ...
                <div class="mt-1">
                    ...
                    <x-input type="number" name="base_clock" class="w-full block text-black"></x-input>
                </div>
                <div class="mt-1">
                    <x-label for="max_boost_clock" value="Max boost clock"></x-label>
                    <x-input type="number"  name="max_boost_clock" class="w-full block text-black"></x-input>
                </div>
