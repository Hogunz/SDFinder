        ...
        <div class="2xl:container 2xl:mx-auto">
            <div class="md:py-12 lg:px-20 md:px-6 py-9 px-4">
                ...
                <div class="flex justify-between items-center mb-4">
                    <h2 class="lg:text-4xl dark:text-white text-3xl lg:leading-9 leading-7 text-gray-800 font-semibold">
                        Device Finder</h2>

                    <!-- filters Button (md and plus Screen) -->
                    <button onclick="showFilters()"
                        class="rounded-lg cursor-pointer dark:bg-white dark:text-gray-800  dark:hover:bg-gray-100 sm:flex  hover:bg-gray-700  focus:ring-offset-2 focus:ring-gray-800 py-4 px-6 bg-gray-800 flex text-base leading-4 font-normal text-white justify-center items-center">
            ...
            <div id="filterSection"
                class="block mb-8 relative md:py-10 lg:px-20 md:px-6 py-9 px-4 bg-gray-50 dark:bg-gray-800 w-full">
                <!-- Cross button Code -->
                ...
                <div class="">
                    ...
                    <div class="md:flex  md:space-x-6 mt-8 grid grid-cols-3 gap-y-8 flex-wrap">
                                        ...
                                        <li>
                                            <div class="flex items-center">
                                                ...
                                                <label for="brand-{{ $brand->id }}"
                                                    class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">{{ $brand->name }}</label>
                                            </div>
                                        </li>
                                    @endforeach
                        ...
                        <div class="flex space-x-2 md:justify-center md:items-center items-center justify-start">
                            ...
                            <!-- Dropdown menu -->
                            <div id="dropdownDefaultCheckbox16"
                                class="hidden z-10 w-48 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600"
                                data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="bottom"
                                style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(0px, 1210px);">
                                <ul class="p-3 space-y-3 text-sm text-gray-700 dark:text-gray-200"
                ...
                <div>
                    ...
                    <div class="md:flex md:space-x-6 mt-8 grid grid-cols-3 gap-y-8 flex-wrap">
                        <div class="flex space-x-2 md:justify-center md:items-center items-center justify-start">
                            <div class="inline-block">
                                <div class="flex space-x-6 justify-center items-center">
                                    ...
                                    <!-- Dropdown menu -->
                                    <div id="dropdownDefaultCheckbox1"
                                        class="hidden z-10 w-48 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600"
                        ...
                        <div class="flex justify-center items-center">
                            <div class="inline-block">
                                <div class="flex space-x-6 justify-center items-center">
                                    <button id="dropdownCheckboxButton2"
                ...
                <div>
                    ...
                    <div class="md:flex md:space-x-6 mt-8 grid grid-cols-4 gap-y-8 flex-wrap" x-data="os">
                        <div class="flex space-x-2 md:justify-center md:items-center items-center justify-start">
                            <div class="inline-block">
                                <div class="flex space-x-6 justify-center items-center">
                                    <button id="dropdownCheckboxButton"
                                        data-dropdown-toggle="dropdownDefaultCheckbox4"
                                        class="  dark:text-gray-300 font-normal text-gray-600  hover:bg-gray-300 focus:ring-4 focus:outline-none focus:ring-gray-300  rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                        type="button">OS
                                        <svg class="ml-2 w-4 h-4" aria-hidden="true" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24"
                                    ...
                                    <!-- Dropdown menu -->
                                    <div id="dropdownDefaultCheckbox4"
                                        class="hidden z-10 w-48 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600"
                                        data-popper-reference-hidden="" data-popper-escaped=""
                                        data-popper-placement="bottom"
                                        style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(0px, 1210px);">
                        ...
                        <div class="flex justify-center items-center">
                            <div class="inline-block">
                                <div class="flex space-x-6 justify-center items-center">
                                    <button id="dropdownCheckboxButton"
                                        data-dropdown-toggle="dropdownDefaultCheckbox5"
                                        class="  dark:text-gray-300 font-normal text-gray-600  hover:bg-gray-300 focus:ring-4 focus:outline-none focus:ring-gray-300  rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                        type="button">OS Version
                                        <svg class="ml-2 w-4 h-4" aria-hidden="true" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="flex space-x-6 justify-center items-center">
                            <button id="dropdownCheckboxButton" data-dropdown-toggle="dropdownDefaultCheckbox6"
                                class="  dark:text-gray-300 font-normal text-gray-600  hover:bg-gray-300 focus:ring-4 focus:outline-none focus:ring-gray-300  rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                type="button">Chipset
                                <svg class="ml-2 w-4 h-4" aria-hidden="true" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="flex space-x-6 justify-center items-center">
                            <button id="dropdownCheckboxButton" data-dropdown-toggle="dropdownDefaultCheckbox17"
                                class="  dark:text-gray-300 font-normal text-gray-600  hover:bg-gray-300 focus:ring-4 focus:outline-none focus:ring-gray-300  rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                type="button">CPU Cores
                                <svg class="ml-2 w-4 h-4" aria-hidden="true" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M19 9l-7 7-7-7"></path>
                            ...
                            <!-- Dropdown menu -->
                            <div id="dropdownDefaultCheckbox17"
                                class="hidden z-10 w-48 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600"
                                data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="bottom"
                                style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(0px, 1210px);">
                                <ul class="p-3 space-y-3 text-sm text-gray-700 dark:text-gray-200"
                                    ...
                                    <div class="inline-block">
                                        <div class="flex space-x-6 justify-center items-center">
                                            <div>
                                                ...
                                                <div
                                                    class="md:flex md:space-x-6 mt-8 grid md:grid-cols-3 gap-y-8 flex-wrap">
                                                    <div
                                                        class="flex space-x-2 md:justify-center md:items-center items-center justify-start">
                                                        <div class="inline-block">
                                                            <div class="flex space-x-6 justify-start items-center">
                                                                <button id="dropdownCheckboxButton"
                                                                    data-dropdown-toggle="dropdownDefaultCheckbox8"
                                                                    class="  dark:text-gray-300 font-normal text-gray-600  hover:bg-gray-300 focus:ring-4 focus:outline-none focus:ring-gray-300  rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                                                ...
                                                                <!-- Dropdown menu -->
                                                                <div id="dropdownDefaultCheckbox8"
                                                                    class="hidden z-10 w-48 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600"
                                                    ...
                                                    <div class="flex justify-center items-center">
                                                        <div class="inline-block">
                                                            <div class="flex space-x-6 justify-center items-center">
                                                                <button id="dropdownCheckboxButton"
                                                                    data-dropdown-toggle="dropdownDefaultCheckbox9"
                                                                    class="  dark:text-gray-300 font-normal text-gray-600  hover:bg-gray-300 focus:ring-4 focus:outline-none focus:ring-gray-300  rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                                                    type="button">Notch
                                                                    <svg class="ml-2 w-4 h-4" aria-hidden="true"
                                                                        fill="none" stroke="currentColor"
                                                                ...
                                                                <!-- Dropdown menu -->
                                                                <div id="dropdownDefaultCheckbox9"
                                                                    class="hidden z-10 w-48 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600"
                                                                    data-popper-reference-hidden=""
                                                                    data-popper-escaped=""
                                                                    data-popper-placement="bottom"
                            ...
                            <div>
                                <div class="flex space-x-2 text-gray-800 dark:text-white">
                                    ...
                                    <img class="hidden dark:block"
                                        src="https://tuk-cdn.s3.amazonaws.com/can-uploader/filter1-svg4dark.svg"
                                        alt="materials" />
                                    <p class="lg:text-2xl text-xl lg:leading-6 leading-5 font-medium ">Selfie Camera
                                    </p>
                                </div>
                                <div class="md:flex md:space-x-6 mt-8 grid md:grid-cols-3 gap-y-8 flex-wrap">
                                    <div
