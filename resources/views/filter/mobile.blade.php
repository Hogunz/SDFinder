            ...
            <div>
                ...
                <div class="border flex flex-col max-h-24 h-full px-4 py-2">
                    ...
                    @foreach ($sims as $i => $sim)
                        <div class="flex space-x-2">
                            <x-input type="checkbox" name="sims[]" value="{{ $sim }}"
                                id="{{ 'sim' . $i }}" />
            ...
            <div>
                ...
                <div class="border flex flex-col max-h-24 h-full px-4 py-2">
                    @foreach ($multiples as $i => $multiple)
                        <div class="flex space-x-2">
                            <x-input type="checkbox" name="multiples[]" value="{{ $i }}"
                                id="{{ 'multiple' . $i }}" />
                ...
                <div>
                    ...
                    <div class="border flex flex-col h-full px-4 py-2 max-h-24 overflow-y-auto">
                        ...
                        <template x-for="(os, index) in operatingSystems" :key="`os` + index">
                            <div class="flex space-x-2">
                                <x-input type="checkbox" x-model.number="selectedOs" x-bind:value="os.id"
                                    x-bind:id="`os` + os.id" x-on:change="getVersions()" class="os"
                                    name="os[]" />
                ...
                <div>
                    ...
                    <div class="border flex flex-col h-full px-4 py-2 max-h-24 overflow-y-auto">
                        ...
                        <template x-for="(version, index) in versions" :key="`version` + index">
                            <div class="flex space-x-2">
                                <x-input type="checkbox" name="versions[]" x-model="selectedVersion"
                                    x-bind:value="version.id" x-bind:id="`version` + version.id" />
                ...
                <div>
                    ...
                    <div class="border flex flex-col h-full px-4 py-2 max-h-24 overflow-y-auto">
                        @foreach ($cores as $core)
                            <div class="flex space-x-2">
                                <x-input type="checkbox" value="{{ $core }}" id="{{ 'core' . $core }}"
                                    name="cores[]"></x-input>
            ...
            <div>
                ...
                <div class="border flex flex-col h-full px-4 py-2 max-h-24 overflow-y-auto">
                    @foreach ($cameraResolutions as $i => $cameraResolution)
                        <div class="flex space-x-2">
                            <x-input type="checkbox" value="{{ $cameraResolution }}"
                                id="{{ 'cameraResolution' . $i }}" name="cameraResolutions[]"></x-input>
            ...
            <div>
                ...
                <div class="border flex flex-col h-full px-4 py-2 max-h-24 overflow-y-auto">
                    @foreach ($videos as $i => $video)
                        <div class="flex space-x-2">
                            <x-input type="checkbox" value="{{ $video }}" id="{{ 'video' . $i }}"
                                name="videos[]"></x-input>
            ...
            <div>
                ...
                <div class="border flex flex-col h-full px-4 py-2 max-h-24 overflow-y-auto">
                    <template x-for="i in 5" :key="i">
                        <div class="flex space-x-2">
                            <x-input type="checkbox" x-bind:value="i" x-bind:id="`camera` + i"
                                name="cameraCounts[]"></x-input>
            ...
            <div>
                ...
                <div class="border flex flex-col h-full px-4 py-2 max-h-24 overflow-y-auto">
                    @foreach ($selfieResolutions as $selfieResolution)
                        <div class="flex space-x-2">
                            <x-input type="checkbox" value="{{ $selfieResolution }}"
                                id="{{ 'selfieResolution' . $i }}" name="selfieResolutions[]"></x-input>
