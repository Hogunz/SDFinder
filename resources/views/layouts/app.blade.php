    ...
    <div class="flex flex-col h-screen justify-between font-sans bg-scroll scroll-smooth">
        ...
        <div x-data="setup()" x-init="$refs.loading.classList.add('hidden');" :class="{ 'dark': isDark }" @resize.window="watchScreen()">
            <div class="flex h-screen antialiased text--900 bg--100 dark:bg-dark dark:text-light">
                    ...
                    <nav aria-label="Main"
                        ...
                        <div x-data="{ isActive: false, open: false }">
                            ...
                            <a href="#" @click="$event.preventDefault(); open = !open"
                                ...
                                <span class="ml-2 text-sm"> Device Management </span>
                        ...
                        <div x-data="{ isActive: false, open: false }">
                            ...
                            <a href="#" @click="$event.preventDefault(); open = !open"
                                ...
                                <span class="ml-2 text-sm"> Device Configuration Management </span>
                                <span aria-hidden="true" class="ml-auto">
                                    <!-- active class 'rotate-180' -->
                                    <svg class="w-4 h-4 transition-transform transform" :class="{ 'rotate-180': open }"
                                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                ...
                <!-- Main content -->
                <main class="flex-1 m-8 overflow-auto">
                    {{ $slot }}
                </main>
                            ...
                            <div class="p-4 space-y-4 md:p-8">
                                ...
                                <div class="flex items-center space-x-8">
                                    ...
                                    <button @click="setLightTheme"
                                        ...
                                        :class="{
                                            'border--900 text--900 dark:border-indigo-500 dark:text-indigo-100': !
                                                isDark,
                                            'text--500 dark:text-indigo-500': isDark
                                        }">
                                        <span>
                                    ...
                                    <button @click="setDarkTheme"
                                        class="flex items-center justify-center px-4 py-2 space-x-4 transition-colors border rounded-md hover:text--900 hover:border--900 dark:border-indigo-600 dark:hover:text-indigo-100 dark:hover:border-indigo-500 focus:outline-none focus:ring focus:ring-indigo-400 dark:focus:ring-indigo-700"
                                        :class="{
                                            'border--900 text--900 dark:border-indigo-500 dark:text-indigo-100': isDark,
                                            'text--500 dark:text-indigo-500':
                                                !isDark
                                        }">
                                        <span>
                                            <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none"
                            ...
                            <div class="flex items-center justify-between px-4 pt-4 border-b dark:border-indigo-800">
                                ...
                                <div class="space-x-2">
                                    <button @click.prevent="activeTabe = 'action'"
                                        ...
                                        :class="{
                                            'border-indigo-700 dark:border-indigo-600': activeTabe ==
                                                'action',
                ...
                <div x-transition:enter="transition duration-300 ease-in-out" x-transition:enter-start="opacity-0"
                    ...
                    class="fixed inset-0 z-10 bg-indigo-800" style="opacity: 0.5" aria-hidden="ture"></div>
                <!-- Panel -->
                <section x-transition:enter="transition duration-300 ease-in-out transform sm:duration-500"
                    x-transition:enter-start="-translate-x-full" x-transition:enter-end="translate-x-0"
                    x-transition:leave="transition duration-300 ease-in-out transform sm:duration-500"
