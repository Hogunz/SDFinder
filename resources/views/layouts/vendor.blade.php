                ...
                <div class="flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
                    ...
                    <aside x-show="isSidebarOpen" x-transition:enter="transition-all transform duration-300 ease-in-out"
                        ...
                        <nav aria-label="Main"
                            ...
                            @if(auth()->user()->vendorInformation)
                                ...
                                <div x-data="{ isActive: false, open: false }">
                                    ...
                                    <a href="#" @click="$event.preventDefault(); open = !open"
                                        ...
                                        <span class="ml-2 text-sm"> Devices </span>
                                    ...
                                    <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" arial-label="Components">
                                        ...
                                        <a href="{{ route('vendor.phones.index') }}" role="menuitem"
                            ...
                            <div class="" x-data="{ isActive: false, open: false }">
                                <!-- active & hover classes 'bg-indigo-100 dark:bg-indigo-600' -->
                                <a href="{{ route('vendor.profile.index') }}" class="flex items-center p-2 text-gray-500 transition-colors rounded-md dark:text-light hover:bg-indigo-100 dark:hover:bg-indigo-600">
                                    <span aria-hidden="true">
                                        <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div class="flex items-center justify-between px-4 pt-4 border-b dark:border-indigo-800">
                                    ...
                                    <div class="space-x-2">
                                        <button @click.prevent="activeTabe = 'action'"
                                            ...
                                            :class="{ 'border-indigo-700 dark:border-indigo-600': activeTabe ==
