      ...
      <div class="mr-auto place-self-center lg:col-span-7">
        ...
        <form class=" ">
          ...
          <div class="relative">
            ...
            <input type="search" id="default-search" class="block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border  border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="What kind of Device you want to find?" required>
            <button type="submit" class="  absolute right-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 text-white dark:focus:ring-blue-300">Search</button>
          </div>
        </form>
      </div>
      ...
      <div class="bg-transparent dark:bg-gray">
        <div class="mx-auto max-w-2xl py-16 px-4 sm:py-6 sm:px-6 lg:max-w-7xl lg:px-8">
          <div class="grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
            ...
            @for($i = 0; $i < 4; $i++) <a href="#" class="group ">
              <div class="aspect-w-1 aspect-h-1 w-full xl:aspect-w-7 xl:aspect-h-8">
                <img src="img/welcome_page/smartphone_head.png" alt="" class=" object-contain object-center ">
              </div>
              <h3 class="mt-4 text-sm text-gray-800 dark:text-white">iPhone 14</h3>
