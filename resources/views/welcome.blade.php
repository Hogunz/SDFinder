<x-guest-layout>
  <!-- Section 1 -->
  <section class="bg-transparent  dark:bg-gradient-to-r from-neutral-900 via-neutral-700 to-neutral-600 pt-6">
      ...
      <div class="mr-auto place-self-center lg:col-span-7">
        ...
        <form class=" ">
          ...
          <div class="relative">
            ...
            <button type="submit" class=" text-gray-900 absolute right-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
          </div>
        </form>
      </div>
  ...
  <div class="container mx-auto text-center">
    ...
    <div class="bg-transparent dark:bg-gradient-to-r from-neutral-900 via-neutral-700 to-neutral-600">

      <div class="mx-auto max-w-2xl py-16 px-4 sm:py-6 sm:px-6 lg:max-w-7xl lg:px-8">
        <h6 class="text-2xl pb-6 font-bold dark:text-white text-white  tracking-widest">This Month's Picks</h6>
        <div class="bg-transparent dark:bg-gradient-to-r from-neutral-900 via-neutral-700 to-neutral-600">
          <div class="mx-auto max-w-2xl py-16 px-4 sm:py-4 sm:px-6 lg:max-w-7xl lg:px-8">
            <div class="grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
              <button class="">
                <a href="#" class="group ">
                  <div class="aspect-w-1 aspect-h-1 w-full    xl:aspect-w-7 xl:aspect-h-8">
                    <img src="img/welcome_page/smartphone_head.png" alt="" class="bghover:animate-bounce object-contain object-center ">
                  </div>
                  <h3 class="mt-4 text-sm text-gray-800  dark:text-white">Earthen Bottle</h3>
                  <p class="mt-1 text-lg font-medium text-gray-800  dark:text-white">$48</p>
                </a>
              </button>
              <a href="#" class="group">
                <div class="aspect-w-1 aspect-h-1 w-full    xl:aspect-w-7 xl:aspect-h-8">
                  <img src="img/welcome_page/smartphone_head.png" alt="" class="md:hover:md:animate-bounce object-contain object-center ">
                </div>
                <h3 class="mt-4 text-sm text-gray-800 dark:text-white">Nomad Tumbler</h3>
                <p class="mt-1 text-lg font-medium text-gray-800  dark:text-white">$35</p>
              </a>
              ...
              <a href="#" class="group">
                ...
                <h3 class="mt-4 text-sm text-gray-800  dark:text-white">Focus Paper Refill</h3>
                <p class="mt-1 text-lg font-medium text-gray-800  dark:text-white">$89</p>
              </a>
              ...
              <a href="#" class="group">
                ...
                <h3 class="mt-4 text-sm text-gray-800  dark:text-white">Machined Mechanical Pencil</h3>
                <p class="mt-1 text-lg font-medium text-gray-800 dark:text-white">$35</p>
              </a>
        ...
        <div class="mx-auto max-w-2xl py-16 px-4 sm:py-6 sm:px-6 lg:max-w-7xl lg:px-8">
          <div class="grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
            <button class="">
              <a href="#" class="group ">
                <div class="aspect-w-1 aspect-h-1 w-full xl:aspect-w-7 xl:aspect-h-8">
                  <img src="img/welcome_page/smartphone_head.png" alt="" class="hover:animate-bounce object-contain object-center ">
                </div>
                <h3 class="mt-4 text-sm text-gray-800 dark:text-white">Earthen Bottle</h3>
                <p class="mt-1 text-lg font-medium text-gray-800  dark:text-white">$48</p>
              </a>
            ...
            <a href="#" class="group">
              <div class="aspect-w-1 aspect-h-1 w-full    xl:aspect-w-7 xl:aspect-h-8">
                <img src="img/welcome_page/smartphone_head.png" alt="" class="hover:md:animate-bounce object-contain object-center ">
              </div>
              <h3 class="mt-4 text-sm text-gray-800 dark:text-white">Nomad Tumbler</h3>
              <p class="mt-1 text-lg font-medium text-gray-800  dark:text-white">$35</p>
            </a>
  ...
  <section class="pt-2">
    <div class="container mx-auto text-center ">
      <h6 class="text-2xl font-bold pb-6 dark:text-white text-white tracking-widest text-center">TABLET</h6>
      <header class="pb-6">
        <!-- Background image -->
